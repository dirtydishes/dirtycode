        ...
        <TooltipTrigger
          render={
            <Link
              ...
              className="ml-1 flex min-w-0 flex-1 cursor-pointer items-center gap-1.5 rounded-md px-1.5 py-1 outline-hidden ring-ring transition-colors hover:text-foreground focus-visible:ring-2"
              to="/"
            >
              <span
                className="min-w-0 truncate text-base font-semibold tracking-tight text-foreground sm:text-sm"
                style={{
                  fontFamily:
