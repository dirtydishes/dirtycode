      ...
      <MenuTrigger
        render={
          <Button
            ...
            className={cn(
              isCodexStyle
                ? "composer-footer-control min-w-0 max-w-40 shrink justify-start overflow-hidden whitespace-nowrap px-2 sm:max-w-48 sm:px-3 [&_svg]:mx-0"
                : "composer-footer-control shrink-0 whitespace-nowrap px-2 sm:px-3",
              triggerClassName,
            )}
          />
        }
