    ...
    Effect.gen(function* () {
      ...
      const proposal = {
        ...
        payload: {
          ...
          participantThreadIds: [ThreadId.make("thread:deliberation:proposer")],
          kind: "approach_proposed" as const,
          state: "proposing" as const,
          approachId: "approach:serial-admission",
          authorThreadId: ThreadId.make("thread:deliberation:proposer"),
          summary: "Run conflict-free work in parallel and keep Admission serial.",
          evidence: [{ kind: "thread" as const, id: "thread:deliberation:proposer" }],
        },
      };
      ...
      yield* runtime.recordDeliberation({
        ...
        payload: {
          ...
          participantThreadIds: [
            ThreadId.make("thread:deliberation:proposer"),
            ThreadId.make("thread:deliberation:judge"),
          ],
          kind: "synthesis_recorded",
          state: "decided",
          authorThreadId: ThreadId.make("thread:deliberation:judge"),
