...
export const ProgramPhaseId = makeEntityId("ProgramPhaseId");
export type ProgramPhaseId = typeof ProgramPhaseId.Type;
export const ProgramRequestId = makeEntityId("ProgramRequestId");
export type ProgramRequestId = typeof ProgramRequestId.Type;
export const ProgramEventId = makeEntityId("ProgramEventId");
export type ProgramEventId = typeof ProgramEventId.Type;
export const ProgramWakeId = makeEntityId("ProgramWakeId");
export type ProgramWakeId = typeof ProgramWakeId.Type;
export const ProgramEffectId = makeEntityId("ProgramEffectId");
export type ProgramEffectId = typeof ProgramEffectId.Type;
export const ProgramReceiptId = makeEntityId("ProgramReceiptId");
export type ProgramReceiptId = typeof ProgramReceiptId.Type;
export const ProgramLeaseId = makeEntityId("ProgramLeaseId");
export type ProgramLeaseId = typeof ProgramLeaseId.Type;
export const OwnerResultId = makeEntityId("OwnerResultId");
export type OwnerResultId = typeof OwnerResultId.Type;
export const PhaseCallbackId = makeEntityId("PhaseCallbackId");
export type PhaseCallbackId = typeof PhaseCallbackId.Type;
